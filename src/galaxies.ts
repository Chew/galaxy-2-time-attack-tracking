...
export const galaxiesData: Galaxy[] = [
  ...
  { name: "Flip-Switch Galaxy", normalStars: 2, greenStars: 2, requiredMins: 2, requiredSecs: 15 },
  ...
  { name: "Cloud Flower Galaxy", normalStars: 3, greenStars: 3, requiredMins: 4, requiredSecs: 30 },
